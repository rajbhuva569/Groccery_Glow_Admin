...
// // import './Login.css';
// // import imglogin from '../../assets/person_1.jpg'
...
// //                     <div className="logo_container"><img src={imglogin} alt="Login Image" height={"100%"} style={{ borderRadius: "50%" }} /></div>
// //                     <div className="title_container">
// //                         <p className="title">Login to your Admin Panel</p>
...
// //                         </svg>
// //                         <input placeholder="name@mail.com" title="Input title" name="input-name" type="email" className="input_field" id="email"
// //                             value={email}
...
// //                         </svg>
// //                         <input placeholder="Password" title="Input title" name="input-name" type="password" className="input_field" id="password"
// //                             value={password}
        ...
        <div>
            <form onSubmit={handleLogin} className="form_container">
                ...
                <div className="logo_container">
                    <img src={imglogin} alt="Login Image" height={"100%"} style={{ borderRadius: "50%" }} />
                </div>
                <div className="title_container">
                    <p className="title">Login to your Admin Panel</p>
                    <span className="subtitle">Get started with our app, just create an account and enjoy the experience.</span>
